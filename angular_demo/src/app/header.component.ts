...
@Component({
  ...
  <div class="header-bg" style="background: url('assets/img/header-bg.jpg') center/cover no-repeat; width: 100vw; height: 220px; display: flex; align-items: center; justify-content: center; margin: 0; box-shadow: none; border-radius: 0; padding: 0; position: relative; top: 0; left: 0;">
